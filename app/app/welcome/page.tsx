    ...
    <div className="grow flex flex-col min-h-0">
      <div className="flex flex-col items-center text-center px-6 pt-16 pb-8 gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-muted-foreground text-base leading-snug max-w-65">
            One board. One list. Two people who actually share the load.
          </p>
        </div>
      </div>

      <div className="flex-1 flex items-center justify-center px-10 min-h-0 overflow-hidden">
        <Image
          priority
          src={undrawHappy}
          alt="Two people sharing household tasks"
          className="w-full max-w-xs max-h-full object-contain drop-shadow-sm"
        />
      </div>
      ...
      <div className="flex flex-col gap-4 px-6 pb-10">
        ...
        <div className="flex flex-col gap-2.5 pt-2">
          <Button
            size="lg"
            className="w-full h-13 text-base font-semibold shadow-sm"
            asChild
          >
            <Link href="/app/auth/sign-up">Get started free</Link>
          </Button>
          <Button
            variant="ghost"
            size="lg"
            ...
            asChild
          >
            <Link href="/app/auth/sign-in">I already have an account</Link>
          </Button>
        </div>
      </div>
    </div>
